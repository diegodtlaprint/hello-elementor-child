...
<div id="dropzone">
	...
	<div class="kdtla-row">
		...
		<div class="kdtla-col-md-6">
			<div class="dropzone-cntent">
				...
				<p>Acceptable file formats; .psd, .ai, .pdf, .tiff, .eps, .png. Artwork should be expanded with all text converted to outlines and .psd files should be sent in 300 dpi to scale. No special characters in the file name, 12 MB max file size - for larger use <a href="www.wetransfer.com">wetransfer.com</a> and send to quote@dtlaprint.com</p>
	...
	<div class="kdtla-row">
		<div class="kdtla-col-md-12">
			...
			<label class="add-artwork-label"> Choose File
